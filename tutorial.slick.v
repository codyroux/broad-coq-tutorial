...
Proof.
  eexists; unfold work_week; eauto.
Qed.
...
Proof.
  ...
  destruct w; destruct w0; auto.
Qed.

Theorem is_a_member_complete : forall w l, Mem w l -> is_a_member w l = true.
Proof.
  intros w l h; induction h; simpl.
  - destruct w; auto.
  - rewrite IHh.
    rewrite orb_true_r; auto.
Qed.

Hint Resolve is_a_member_correct is_a_member_complete.

Lemma is_a_member_compute : forall w l, Mem w l <-> is_a_member w l = true.
Proof.
  intros; split; auto.
Qed.
...
Proof.
  exists Sunday.
  rewrite is_a_member_compute.
  unfold work_week; simpl; congruence.
Qed.
